...
sleep 5
ant -Dhostname=localhost -Dpport=18728 -Dmport=8728 -Dncores=8 -Dseeds=localhost:8726,localhost:8727 be &
ant -Dhostname=localhost -Dpport=18729 -Dmport=8729 -Dncores=8 -Dseeds=localhost:8726,localhost:8727 be &
sleep 5
